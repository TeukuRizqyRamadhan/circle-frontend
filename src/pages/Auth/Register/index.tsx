...
const Register = () => {
    ...
    const { onErrorSubmit, onSubmit, error } = useRegisterFunction({ reset });
    ...
    return (
        ...
        >
            <Box
                ...
                <Typography sx={{ color: "white", fontSize: 40, fontWeight: "semibold" }}>Register To Circle</Typography>
                <form>
                    <Box
                        width={"100%"}
                    ...
                    >
                        ...
                        <Link to={"/auth/login"} style={{ textDecoration: "none" }}><Typography sx={{ color: "white" }}>Already have an account? Login</Typography></Link>
                    </Box>
                </form>
            </Box>
        </Box>
